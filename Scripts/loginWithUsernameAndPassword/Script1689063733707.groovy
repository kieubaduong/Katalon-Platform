...
CustomKeywords.'newPackage.ResizeScreenKeyword.enhancedSetViewportSize'(1920, 872)

WebUI.setText(findTestObject('Object Repository/Page_Katalon TestOps/input_Sign Up_username'), 'duong.dep.trai@katalon.com')
